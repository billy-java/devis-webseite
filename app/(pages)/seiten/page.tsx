...
const Seiten = () => {
  ...
  const [seiteEditer, setSeiteEditer] = useState<I_Seite | null>(null);
  const [verstecken, setVerstecken] = useState<boolean>(true);
  const dispatch = useDispatch();

  const [seiteId, setSeiteId] = useState<string>('');
  const [seiteName, setSeiteName] = useState<string>('');
    ...
    {webseiten &&
      ...
      {!verstecken && (
        <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3">
          {seiten
            .filter((el) => el.wb_id === String(seiteId))
            .map((oneSeite, index) => {
              return (
                <div
                  key={index}
                  ...
                  <div>
                    ...
                    <p className="px-4 text-gray-100">{oneSeite.absatz}</p>
                  </div>
                    ...
                    <div className="flex justify-center gap-4 mt-4">
                      <button
                        onClick={() => {
                          ...
                          setSeiteEditer(oneSeite); // Transmet la bonne carte à modifier
                        }}
                      ...
                      <button className="p-2 rounded-full bg-gray-300 group transition-all duration-500 hover:bg-red-600 flex item-center">
                        <svg
                          onClick={() =>
                            dispatch(deleteSeite__Hilfe(oneSeite.id))
                          }
                          className=""
                          width="20"
                          height="20"
      ...
      <Modal_Seite
        ...
        alteSeite={boolUpdate_Parent ? seiteEditer : null}
        seiteID={seiteId}
        onClose={() => {
          setModalOpen(false);
          setBoolUpdate_Parent(false);
