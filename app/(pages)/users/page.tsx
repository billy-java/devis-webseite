...
const UsersManager = () => {
  ...
  const [userEditer, setUserEditer] = useState<I_User | null>(null);
  ...
  return (
    <div className="h-full min-h-screen w-full pt-12 p-4">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3">
        {user &&
          users.map((oneUser: I_User, index: number) => {
            return (
              <div
                key={index}
                  ...
                  <div className="flex justify-center gap-4 mt-4">
                    <button
                      onClick={() => {
                        ...
                        setUserEditer(oneUser); // Transmet la bonne carte à modifier
                      }}
                    ...
                    <button
                      onClick={() =>
                        dispatch(deleteBenutzer__Hilfe(oneUser.id))
                      }
                ...
                <Modal_User
                  ...
                  aelterUser={boolUpdate_Parent ? userEditer : null}
                  onClose={() => {
                    setModalOpen(false);
                    setBoolUpdate_Parent(false);
                  }}
